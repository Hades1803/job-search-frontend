    ...
    return (
        <Link to='/jobs' className='bg-mine-shaft-900 p-4 w-72 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400'>
            <div className='flex justify-between'>
                <div className='flex gap-2 items-center'>
                    ...
                    <div>
                        ...
                        <div className='text-xs text-mine-shaft-50'>{props.company} &#x2022; {props.applicants} applicant</div>
                    </div>
                </div>
            ...
            }
            {
                ...
                <IconCalendarMonth stroke={1.5} className='text-bright-sun-400 w-5 h-5'/> Sun, 25 August &bull; <span className='text-mine-shaft-400'>10:00 AM</span>
            </div> 
            }
        </Link>
    )
