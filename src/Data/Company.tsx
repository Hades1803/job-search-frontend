...
const similar=[
    ...
    {name:"Google", employees:190234},
    {name:"Amazon", employees:1541000},
    {name:"Apple", employees:164000},
    {name:"Adobe", employees:29700},
    {name:"IBM", employees:288300},
    {name:"Salesforce", employees:73000},
    {name:"Oracle", employees:143000}
];

const data = { companyData, similar }; 
